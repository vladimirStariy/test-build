  ...
  return (
    <Nav>
        <ul className={`nav font-manrope ${props.link_type === 'COL' ? styles.zvzcCOL : 'nav-underline ' + styles.zvzcROW }`}>
            ...
            <li className="nav-item">
                <Nav.Link to="/client" as={NavLink} className={styles.navLink}>
                    Клиенту
                </Nav.Link>
            </li>
            <li className="nav-item">
                <Nav.Link to="/for-order" as={NavLink} className={styles.navLink}>
                    Под заказ
                </Nav.Link>
            </li>
            <li className="nav-item">
                <Nav.Link to="/novelties" as={NavLink} className={styles.navLink}>
                    Новинки
                </Nav.Link>
            </li>
            <li className="nav-item">
